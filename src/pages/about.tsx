    ...
    <DefaultLayout>
      ...
      <section className="py-5">
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-4 col-6 mx-lg-8 mx-auto px-lg-0 px-md-0 my-auto">
              <img className="w-100 border-radius-lg shadow" src="/assets/images/steve/thefam1.jpg" />
            </div>
      ...
      <section className="py-5">
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-lg-4 col-6 mx-lg-8 mx-auto px-lg-0 px-md-0 my-auto">
              <img className="w-100 border-radius-lg shadow" src="/assets/images/steve/thefam2.png" />
            </div>
          </div>
        </div>
      </section>
